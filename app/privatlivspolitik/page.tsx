 ...
 * nu så checkout-flowets accept-link ikke peger på en 404, mens den
 * egentlige privatlivspolitik udarbejdes.
 */
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <p className="mb-4 text-sm text-slate-500">
            Denne side er under udarbejdelse. Bygnors fulde privatlivspolitik
            om behandling af persondata offentliggøres her snarest.
          </p>
