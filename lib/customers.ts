...
// MFA-nulstilling er flyttet til lib/mfa-admin.ts (getUserMfaEnabled/
// resetUserMfa) — logikken er generisk pr. bruger-id og gælder ikke kun
// kunder, se /admin/users som nu også bruger den.
